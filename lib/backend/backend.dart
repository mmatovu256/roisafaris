...
import 'schema/destination_categories_record.dart';
...
export 'schema/destination_categories_record.dart';
...
/// Functions to query DestinationCategoriesRecords (as a Stream and as a Future).
Future<int> queryDestinationCategoriesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      DestinationCategoriesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<DestinationCategoriesRecord>> queryDestinationCategoriesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      DestinationCategoriesRecord.collection,
      DestinationCategoriesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<DestinationCategoriesRecord>> queryDestinationCategoriesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
